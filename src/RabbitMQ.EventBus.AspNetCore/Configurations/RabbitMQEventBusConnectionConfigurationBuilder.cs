...
{
    public class RabbitMQEventBusConnectionConfigurationBuilder
    {
        ...
        public RabbitMQEventBusConnectionConfigurationBuilder(RabbitMQEventBusConnectionConfiguration configuration)
        {
